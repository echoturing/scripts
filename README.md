...
python random_excel_rows.py demo_input.xlsx out.xlsx --m 部门 性别 --frac 0.5

#  跟上边一样,只是在 过滤掉 out1.xlsx 和 out2.xlsx 在 demo_input.xlsx 里的索引(0 开始) 后再操作
python random_excel_rows.py demo_input.xlsx out.xlsx --m 部门 性别 --frac 0.5 --exclude out1.xlsx out2.xlsx
```
## 